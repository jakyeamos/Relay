...
summary: Dogfood-verified native macOS Relay with bounded Codex ingestion, nested event normalization, crash-safe monitor notifications, responsive Observe and Resume surfaces, deterministic Playbook Intelligence, Unified Usage metrics, guarded file transactions, and login startup.
...
sourceOfTruth: commit 637d6c9 plus translated crash-report analysis, native UI dogfood, release build, and Pre-CR readback
healthScore: 90
